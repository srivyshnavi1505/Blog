...
const OnUserRegister = async(newUser)=>{
  ...
  try{
    ...
    let resObj = await axios.post(url, formData);
  ...
  <div className="min-h-screen bg-zinc-950 flex items-center justify-center px-4 py-12">
    <div className="w-full max-w-md">
      ...
      >
        ...
        <div className="flex gap-3">
          <div className="flex-1">
            <input
              ...
              className="w-full bg-zinc-800 border border-zinc-700 text-white px-4 py-2.5 rounded-lg"
        ...
        {/* BUTTON */}
        <button className="w-full bg-teal-500 hover:bg-teal-400 text-white py-2.5 rounded-lg">
          Create Account
        </button>
      </form>
    </div>
